...
class SystemProp:
    ...
    Attributes:
        ...
        Coulomb_log (float): Coulomb logarithm
        sigma (float): velocity dispersion
    """


    def __init__(self, m1, m2, halo1, halo2, sigma, Coulomb_log, k=0, D=1., inclination_angle = 0., pericenter_angle=0., includeHaloInTotalMass=False, relcorr = False):
        """
